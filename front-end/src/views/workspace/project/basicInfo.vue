    ...
    <div class="grid grid-cols-[400px,1fr] gap-8">
      ...
      <div class="animate__animated animate__fadeIn animate__delay-2s">
        <a-popover title="编辑作品封面" trigger="hover">
          <template #content>
            <div class="flex flex-nowrap gap-2">
              <button
                class="flex items-center gap-1 px-3 py-1.5 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-lg hover:opacity-90 transition-all"
                @click="generateCover"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <button
                class="flex items-center gap-1 px-3 py-1.5 border theme-border rounded-lg hover:border-blue-500 transition-all"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-4 w-4"
              ...
              <button
                class="flex items-center gap-1 px-3 py-1.5 text-red-500 border border-red-200 dark:border-red-800 rounded-lg hover:bg-red-50 dark:hover:bg-red-900/20 transition-all"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-4 w-4"
          ...
          <div
            class="w-full h-[500px] border theme-border rounded-xl overflow-hidden group relative hover:border-blue-500 transition-all"
          >
            <!-- 加载状态 -->
            <div
              v-if="options.isCoverGenerating"
        ...
        <div class="space-y-4 mt-4">
          <!-- 风格标签 -->
          <div
            class="p-4 border theme-border rounded-xl bg-white/50 dark:bg-zinc-900/50 backdrop-blur-sm animate__animated animate__fadeIn animate__delay-3s"
          >
            <h2
              class="text-lg font-semibold bg-gradient-to-r from-blue-500 to-cyan-500 bg-clip-text text-transparent mb-3"
            >
              创作风格
            </h2>
          ...
          <!-- 目标人群标签 -->
          <div
            class="p-4 border theme-border rounded-xl bg-white/50 dark:bg-zinc-900/50 backdrop-blur-sm animate__animated animate__fadeIn animate__delay-4s"
          >
            <h2
              class="text-lg font-semibold bg-gradient-to-r from-blue-500 to-cyan-500 bg-clip-text text-transparent mb-3"
            >
      ...
      <div class="flex flex-col gap-2">
        <div
          class="p-6 border theme-border rounded-xl mb-6 gradient-bkg backdrop-blur-sm animate__animated animate__fadeIn animate__delay-5s"
        >
          <!-- AI 生成加载状态 -->
          <div
            v-if="options.isTextGenerating"
          ...
          <template v-else>
            ...
            >
              <div class="flex items-center justify-between mb-2">
                <h2
                  class="text-xl font-semibold bg-gradient-to-r from-blue-500 to-cyan-500 bg-clip-text text-transparent"
                >
                  {{ item.label }}
                </h2>
            ...
            <div class="flex items-center gap-4 mt-6">
              ...
              <template v-else>
                ...
                <button
                  class="flex items-center gap-2 px-4 py-2 border theme-border rounded-lg hover:border-blue-500 transition-colors"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-5 w-5"
        ...
        <!-- 团队信息卡片 -->
        <div
          class="mt-6 p-6 gradient-bkg rounded-xl border theme-border animate__animated animate__fadeIn animate__delay-6s"
        >
          <div class="flex items-center justify-between mb-4">
            <h2
              class="text-xl font-semibold bg-gradient-to-r from-indigo-500 to-blue-500 bg-clip-text text-transparent"
            >
              团队信息
            </h2>
