...
const routeList = [
  {
    path: '/workspace/editProject/index',
    name: '概览',
...
`
    ...
    path: '/workspace/editProject/characters',
    name: '角色',
    icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
...
`
    ...
    path: '/workspace/editProject/chapters',
    name: '篇章',
    icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
...
`
    ...
    path: '/workspace/editProject/writing',
    name: '创作',
    icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
...
`
    ...
    path: '/workspace/editProject/export',
    name: '发布',
    icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
...
<template>
  <div class="h-full w-full flex flex-col gap-2 workspace-box animate__animated animate__fadeIn font-serif p-2">
    ...
    <div class="flex-1 overflow-y-auto rounded-xl border theme-border bg-[#f1f4fa]/20 dark:bg-gray-950/10 p-4">
      <router-view/>
    </div>
  </div>
</template>
