...
<template>
  <div class="min-h-screen py-8 bg-gray-50 dark:bg-zinc-900/60 rounded-xl">
    <div class="max-w-7xl mx-auto px-4">
      ...
      <template v-else>
        <!-- 轮播图区域 -->
        <div class="mb-12 rounded-2xl overflow-hidden border theme-border animate__animated animate__fadeIn">
          <a-carousel autoplay>
            <div 
        ...
        <!-- 页面标题和筛选区 -->
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8 animate__animated animate__fadeIn animate__delay-1s">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div v-for="(project, index) in options.projects" 
            :key="project.ID"
