...
<div class="font-sans text-theme-switch">
  ...
  <div class="w-full flex mt-4">
    <button class="mx-auto btn1">
      登录
    </button>
  </div>
  <div class="mt-2 flex"><span class="mx-auto">还没有账号?<a class="text-hover cursor-pointer hover:underline" @click="router.push('/auth/register')">注册一个</a></span></div>
</div>
</template>
